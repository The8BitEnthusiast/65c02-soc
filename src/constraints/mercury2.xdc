...
set_property -dict {PACKAGE_PIN F2 IOSTANDARD LVCMOS33} [get_ports {rts}];  # io[2]
set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS33} [get_ports {cts}];  # io[3]
...
#set_property -dict {PACKAGE_PIN D1 IOSTANDARD LVCMOS33} [get_ports {ascii_code[4]}];      # io[31]
#set_property -dict {PACKAGE_PIN L2 IOSTANDARD LVCMOS33} [get_ports {ascii_code[3]}];      # io[32]
#set_property -dict {PACKAGE_PIN G5 IOSTANDARD LVCMOS33} [get_ports {ascii_code[2]}];      # io[33]
#set_property -dict {PACKAGE_PIN H5 IOSTANDARD LVCMOS33} [get_ports {ascii_code[1]}];      # io[34]
#set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports {ascii_code[0]}];      # io[35]
#set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports {ascii_new}];          # io[36]
